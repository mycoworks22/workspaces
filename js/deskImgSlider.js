const deskImgSlider = () => {
   const slider = document.querySelector(".deskCarouselSlides");
   const slides = document.querySelectorAll(".deskCarouselSlide");
   const prev = document.querySelector(".deskCarousel__control--prev");
   const next = document.querySelector(".deskCarousel__control--next");
   ...
   cloneFirst.setAttribute("class", "deskCarouselSlide");
   cloneLast.setAttribute("class", "deskCarouselSlide");

   //new slides
   const newSlides = document.querySelectorAll(".deskCarouselSlide");
